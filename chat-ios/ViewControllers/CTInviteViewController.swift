...
class CTInviteViewController: CTViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func loadView(){
        ...
        self.topView = UIView(frame: CGRect(x: 0, y: 0, width: frame.size.width, height: 84))
